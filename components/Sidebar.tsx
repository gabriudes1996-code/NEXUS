  ...
  return (
    <aside className="w-20 lg:w-80 bg-[#020617] border-r border-white/5 flex flex-col transition-all z-50">
      <div className="p-10 flex items-center gap-5">
        <div className="w-14 h-14 bg-blue-600 rounded-[1.5rem] flex items-center justify-center shadow-2xl shadow-blue-900/40 transform hover:scale-105 transition-all cursor-pointer">
        ...
        <div className="hidden lg:block">
          ...
          <span className="text-[9px] font-black text-blue-500 uppercase tracking-[0.45em] mt-1.5 block">Assessoria</span>
        </div>
      </div>
      ...
      <nav className="flex-1 px-6 mt-16 space-y-4">
        {menuItems.map((item) => (
          <button
            ...
            className={`w-full flex items-center gap-5 px-6 py-5 rounded-[2rem] text-sm font-bold transition-all relative group ${
              activeTab === item.id
      ...
      <div className="p-8">
        {!isAdmin && (
          <div className="hidden lg:block mb-10 p-7 bg-white/5 rounded-[2.5rem] border border-white/5">
             <div className="flex items-center gap-4 mb-5">
               <div className="w-10 h-10 rounded-2xl bg-blue-500/10 flex items-center justify-center font-black text-xs text-blue-500 border border-blue-500/20 shadow-xl">AZ</div>
               <div>
