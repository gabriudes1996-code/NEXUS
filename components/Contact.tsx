  ...
  return (
    <section id="contact" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative bg-[#0A2342] rounded-[3rem] overflow-hidden shadow-2xl shadow-slate-900/20 border border-[#C5A059]/10">
          ...
          <div className="grid lg:grid-cols-2 relative z-10">
            <div className="p-12 lg:p-20 text-white flex flex-col justify-center">
              <h2 className="text-4xl lg:text-5xl font-extrabold mb-8 leading-tight tracking-tighter">Vamos começar a <span className="text-[#C5A059]">vencer</span> hoje?</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-[#C5A059]/10 backdrop-blur-md rounded-xl flex items-center justify-center border border-[#C5A059]/20">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-[#C5A059] text-sm font-bold uppercase tracking-wider">E-mail</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[#C5A059] text-sm font-bold uppercase tracking-wider">WhatsApp</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full px-4 py-4 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#C5A059]/20 focus:border-transparent transition-all bg-slate-50 font-medium"
                ...
                <button
                  type="submit"
                  className="w-full py-5 bg-[#C5A059] text-[#0A2342] font-black uppercase tracking-widest text-sm rounded-xl hover:bg-[#E5C789] transition-all shadow-xl shadow-[#C5A059]/10 flex items-center justify-center gap-2"
                >
                  Enviar Mensagem
